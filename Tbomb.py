...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf H.R.Bomber && git clone https://github.com/azizulislam3/H.R.Bomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd H.R.Bomber && python h.r.aziz.py")
...
def logo():
    ...
    print("\033[94m |      \033[92m | |   | |__| |   | || |              | || |   | |__) |   | || |              | || |    | |_) |   | || |  /  .--.  \  | || |  |   \/   |  | || |    | |_) |   | || |   | |_  \_|  | || |   | |__) |   | | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | |   |  __  |   | || |              | || |   |  __ /    | || |              | || |    |  __'.   | || |  | |    | |  | || |  | |\  /| |  | || |    |  __'.   | || |   |  _|  _   | || |   |  __ /    | | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | |  _| |  | |_  | || |      _       | || |  _| |  \ \_  | || |      _       | || |   _| |__) |  | || |  \  `--'  /  | || | _| |_\/_| |_ | || |   _| |__) |  | || |  _| |___/ |  | || |  _| |  \ \_  | | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | | |____||____| | || |     (_)      | || | |____| |___| | || |     (_)      | || |  |_______/   | || |   `.____.'   | || ||_____||_____|| || |  |_______/   | || | |_________|  | || | |____| |___| | | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' | \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  \033[94m   │".center(columns+15))\033[94m   │".center(columns+15))\033[94m   │".center(columns+15))\033[94m   │".center(columns+15))
